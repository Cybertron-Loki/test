...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    concerts: Schema.Attribute.Relation<'oneToMany', 'api::ticket.ticket'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    musicType: Schema.Attribute.String;
    name: Schema.Attribute.String;
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    concert_tickets: Schema.Attribute.Relation<
      'oneToMany',
      'api::concert-ticket.concert-ticket'
    >;
    concerts: Schema.Attribute.Relation<'oneToMany', 'api::ticket.ticket'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiConcertTicketConcertTicket
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    concert: Schema.Attribute.Relation<'oneToOne', 'api::ticket.ticket'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    priceA: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    saleFininshTime: Schema.Attribute.DateTime;
    saleStartTime: Schema.Attribute.DateTime;
    ticketNumber: Schema.Attribute.Integer;
    ticketStatus: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    concert_ticket: Schema.Attribute.Relation<
      'oneToOne',
      'api::concert-ticket.concert-ticket'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    performanceDate: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::concert-ticket.concert-ticket': ApiConcertTicketConcertTicket;
